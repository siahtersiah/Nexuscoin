...
An airdrop is an application where a set number users are able to claim a specific amount of an asset. In today's ecosystem, this is often used to distribute tokens to an application's user base that  previously interacted with their project.
...
TODO: The user interface not currently exist therefore its [README.md](ui/README.md) and [SPECIFICATION.md](ui/SPECIFICATION.md) are empty.
